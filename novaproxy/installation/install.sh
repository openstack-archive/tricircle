...
config_option_list="proxy_region_name=AZ1 cascading_nova_url=http://10.67.148.210:8774/v2 cascaded_nova_url=http://10.67.148.201:8774/v2 cascaded_neutron_url=http://10.67.148.201:9696 cascaded_glance_flag=False cascaded_glance_url=http://10.67.148.201:9292 os_region_name=Cascading_Openstack keystone_auth_url=http://10.67.148.210:5000/v2.0/ cinder_endpoint_template=http://10.67.148.210:8776/v1/%(project_id)s compute_manager=nova.compute.manager_proxy.ComputeManager"
