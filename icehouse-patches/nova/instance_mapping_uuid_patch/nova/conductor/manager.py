...
class _ConductorManagerV2Proxy(object):
    ...
    def bw_usage_update(self, context, uuid, mac, start_period,
        ...
        return self.manager.bw_usage_update(
            context,
            uuid,
            mac,
            start_period,
    ...
    def block_device_mapping_update_or_create(self, context, values, create):
        return self.manager.block_device_mapping_update_or_create(
            context,
            values,
            create)
    ...
    def block_device_mapping_get_all_by_instance(self, context, instance,
                                                 legacy):
        return self.manager.block_device_mapping_get_all_by_instance(
            context,
            instance,
            legacy)
    ...
    def instance_get_all_by_filters(self, context, filters, sort_key,
        ...
        return self.manager.instance_get_all_by_filters(
            context,
            filters,
            sort_key,
            sort_dir,
    ...
    def vol_usage_update(self, context, vol_id, rd_req, rd_bytes, wr_req,
        ...
        return self.manager.vol_usage_update(
            context,
            vol_id,
            rd_req,
            rd_bytes,
    ...
    def notify_usage_exists(self, context, instance, current_period,
                            ignore_missing_network_data,
                            system_metadata, extra_usage_info):
        return self.manager.notify_usage_exists(
            context,
            instance,
            current_period,
            ignore_missing_network_data,
