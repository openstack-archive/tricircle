...
_NEUTRON_L2_PROXY_FILE="plugins/l2_proxy_agent/l2_cascading_proxy.ini"
...
sed -i "s/CASCADEDING_REGION_NAME/$CASCADEDING_REGION_NAME/g" "${_NEUTRON_CONF_DIR}/${_NEUTRON_L2_PROXY_FILE}"
